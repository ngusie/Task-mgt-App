...
import { toast } from "react-toastify";
 ...
 const Login = () => {
     ...
     return (
        ...
        <h2>Login</h2>
        <p>Input Username / Password must be "passcode"</p>
        <form onSubmit={doLogin} className="inputs">
            ...
            <div className="input mt-2">
                <input placeholder="Password" value={formData.password} onChange={(e) => setFormData({ password: e.target.value })} type="passcode" />
            </div>
